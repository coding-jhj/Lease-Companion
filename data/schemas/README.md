...
- **`generated/` — canonical v1.8.0 읽기 호환·v1.9.0 신규 출력 JSON Schema 생성본(2026-07-25).** `ai/src/lease_companion_ai/schemas/`의 Pydantic 모델에서 자동 생성한 17개. **손으로 수정하지 않는다.** 재생성 명령:
