...
- 구현 완료(2026-07-16): `schemas/`의 Pydantic 모델 v1.2.0이 런타임 통합 스키마 단일 원본이며 `RuleResult` 13필드에 `result_type`·`triggers_actions`를 포함한다 (`../docs/decisions/2026-07-16-shared-pydantic-schema.md`).
