...
- `minimum_mvp.py` — R01~R24 규칙. R11~R19의 확인 입력 기반 판정, R16·R23·R24 질문형 확인, R20~R22 외부 연동 대기 상태를 포함한다.
...
- `schemas/adapters.py::analyze_snapshot()`이 신규 실행에서 R01~R24와 J01~J12를 함께 실행한다. 기존 R01~R10 저장 결과는 읽기 호환한다.
