...
- `ragas_offline.py`: RAGAS `IDBasedContextPrecision`·`IDBasedContextRecall`로 일반 RAG source Top-5와 특약 source·section Top-3를 API 키 없이 측정.
...
- `scripts/evaluate_ragas_offline.py`: RAGAS ID 지표를 `data/evaluation/results/ragas_offline_metrics.json`에 기록.
