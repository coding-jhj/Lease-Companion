...
- `models.py`: provider 초안과 검증 완료 안내를 규칙 결과와 분리한 내부 Pydantic 계약
...
- 공개 Backend·Frontend canonical 타입 연결은 별도 변경으로 남김
...
- 합성 CASE-001 유료 smoke와 Backend 저장 연결은 각각 키·비용 승인 및 공개 계약 합의 후 진행
