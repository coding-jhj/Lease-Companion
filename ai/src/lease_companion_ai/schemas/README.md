...
- **`unified.py` — 통합 스키마 v1.9.0 전환 계약 구현(2026-07-18).** 기존 v1.8.0 타입에 ClassificationInput·ClassificationResult·ClauseInput·ClauseCandidate와 provider/safe_fallback provenance를 추가했다. Backend runtime·Frontend는 공동 전환 전까지 v1.8.0 계약을 유지한다.
