...
const stages: Array<{ id: AnalysisStage; title: string; description: string }> = [
  { id: "request", title: "분석 요청 접수", description: "확인한 계약 정보를 분석 서버에 전달합니다." },
  ...
  { id: "complete", title: "리포트 준비 완료", description: "확인 결과와 방어 행동을 리포트에서 볼 수 있습니다." },
];
  ...
  return (
    <section className="analysis-timeline" aria-labelledby="analysis-timeline-title">
      <div className="analysis-timeline__heading">
        <p>현재 처리 단계</p>
        <h2 id="analysis-timeline-title">계약 분석 진행 상황</h2>
      </div>
      <ol>
