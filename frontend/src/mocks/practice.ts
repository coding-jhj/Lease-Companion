...
const scenarios: MockScenario[] = [
  {
    ...
    initial_turn: turn("TURN-01", "특약대로 다음 세입자가 들어오면 보증금을 바로 돌려드리겠습니다. 이 조건을 확인하셨죠?", true),
    turns: [
      turn("TURN-01", "특약대로 다음 세입자가 들어오면 보증금을 바로 돌려드리겠습니다. 이 조건을 확인하셨죠?", true),
      turn("TURN-02", "새 세입자는 금방 구해질 테니 걱정하지 않으셔도 됩니다. 구두로 확실히 약속드리겠습니다."),
      turn("TURN-03", "특약은 나중에도 협의할 수 있습니다. 우선 오늘 계약서에 서명하시죠."),
    ],
