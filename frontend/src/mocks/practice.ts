...
const scenarios: MockScenario[] = [
  ...
  },
  {
    ...
    turns: [
      ...
      turn("TURN-03", "다른 분도 계약하려고 하니 100만 원을 보내야 집을 잡아 둘 수 있습니다. 확인 자료는 송금 뒤에 드리겠습니다.", true),
    ],
  ...
  },
  {
    ...
    turns: [
      ...
      turn("TURN-03", "집을 잡으려면 지금 대리인 박민준 씨와 계약하고 그분 계좌로 계약금을 보내셔야 합니다. 서류는 뒤에 보완하겠습니다."),
    ],
